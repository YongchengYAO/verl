#! /bin/bash
# ================================================================================================
# MedVision RFT (GRPO) -- multi-task RFT with the additive reward composition
#
# Settings:
#   experiment ....... additive-reward ablation: identical to train__rft-multitask.sh except the combination rule (r = format + process + answer)
...
#   reward ........... format_reward=soft, composition=additive
#
# Usage:
...
#   bash examples/grpo_trainer/train__rft-multitask__additive-reward.sh
#
...
#   EXP_NAME         experiment name (default: rft-multitask__additive-reward); checkpoints and logs land under
...
exp_name="${EXP_NAME:-rft-multitask__additive-reward}"
