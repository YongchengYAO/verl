#! /bin/bash
# ================================================================================================
# MedVision RFT (GRPO) -- sequential stage 2 of 3: T/L RFT
#
# Settings:
#   experiment ....... MedVision-V0 stage 2: T/L RFT (the merged checkpoint feeds stage 3, train__rft-sequential__3-detection.sh)
#   base model ....... stage 1's checkpoints/<EXP_NAME>/global_step_<N>/actor/merged_hf_model
#   dataset variant .. ds__AD0_D0_TL5500_all5500__resized-hw-512x512
#   reward ........... format_reward=soft, composition=multiplicative
#
# Usage:
#   DATASET_ROOT=<data_dir>/verl_datasets/qwen25vl/ds__AD0_D0_TL5500_all5500__resized-hw-512x512 \
#   BASE_MODEL_PATH=examples/grpo_trainer/checkpoints/rft-sequential__1-AD/global_step_<N>/actor/merged_hf_model \
#   bash examples/grpo_trainer/train__rft-sequential__2-TL.sh
#
...
#   EXP_NAME         experiment name (default: rft-sequential__2-TL); checkpoints and logs land under
...
exp_name="${EXP_NAME:-rft-sequential__2-TL}"
...
#   BASE_MODEL_PATH  local checkpoint directory (stage 1's global_step_N/actor/merged_hf_model)
